...
train_dataloader = TrainDataLoader(
	in_path = "./benchmarks/DBpedia-GT20E/", 
	nbatches = 100,
	threads = 8, 
...
# dataloader for test
test_dataloader = TestDataLoader("./benchmarks/DBpedia-GT20E/", "link")
...
trainer.run()
distmult.save_checkpoint('./checkpoint/DBpedia-GT20E_distmult.ckpt')

# test the model
distmult.load_checkpoint('./checkpoint/DBpedia-GT20E_distmult.ckpt')
