...
train_dataloader = TrainDataLoader(
	in_path = "./benchmarks/DBpedia-GT5E/", 
	nbatches = 100,
	threads = 8, 
...
# dataloader for test
test_dataloader = TestDataLoader("./benchmarks/DBpedia-GT5E/", "link")
...
trainer.run()
distmult.save_checkpoint('./checkpoint/DBpedia-GT5E1_distmult.ckpt')

# test the model
distmult.load_checkpoint('./checkpoint/DBpedia-GT5E1_distmult.ckpt')
