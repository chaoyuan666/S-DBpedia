...
train_dataloader = TrainDataLoader(
	in_path = "./benchmarks/DBpedia-RDM25/", 
	nbatches = 100,
	threads = 8, 
...
# dataloader for test
test_dataloader = TestDataLoader("./benchmarks/DBpedia-RDM25/", "link")
...
trainer.run()
distmult.save_checkpoint('./checkpoint/DBpedia-RDM25_distmult.ckpt')

# test the model
distmult.load_checkpoint('./checkpoint/DBpedia-RDM25_distmult.ckpt')
